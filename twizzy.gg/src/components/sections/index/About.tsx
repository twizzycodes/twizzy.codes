...
export default function About() {
  ...
  useEffect(() => {
    const socket = new WebSocket(`wss://api.twizzy.gg/presence`)

    const sendWhenOpen = (message: string) => {
    ...
    const handleOpen = () => {
      sendWhenOpen("Connection established")
    }
    ...
    <>
      <section id='about' className="max-w-4xl w-full flex flex-col mx-auto">
        ...
        <ul className="grid grid-cols-2 gap-4 mt-4">
          <AboutCard
            title="Overall"
            description="I've been running websites and other projects since the age of 13 but didn't learn how to code until I was nearly 15 as it took me a bit to find a good way to start learning. By the end of my education, I hope to secure a rewarding job in web development, as it is a lifelong passion of mine. I enjoy creating things and find great satisfaction when others genuinely use and appreciate the end product."
            direction="top"
            span={2}
            delay={0.1}
